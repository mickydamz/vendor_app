                                            ...
                                            <div class="card-inner">
                                                ...
                                                <div class="row g-gs">
                                                    <div class="col-md-4">
                                                        ...
                                                        <small class="currency currency-usd">USD</small></div>
                                                            <!-- <div class="user-balance-sub">Locked <span>0.00 <span class="currency currency-btc">BTC</span></span></div> -->
                                                        </div>
                                                    </div><!-- .card-inner -->
                                                    </div><!-- .card-inner -->
                                                    ...
                                                    <div class="nk-block-between">
                                                        <div class="nk-block-head-content">
                                                            ...
                                                            <div class="nk-block-des">
                                                                <p>Basic info, like your name and address, that you use on data collection Platform.</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="nk-data data-list">
                                                        ...
                                                        <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                                                            <div class="data-col">
                                                                ...
                                                                <span class="data-value text-soft">{{ auth()->user()->phone_no ?? 'not added yet'}}</span>
                                                            </div>
                                                            <div class="data-col data-col-end"><span class="data-more"><em class="icon ni ni-forward-ios"></em></span></div>
                                                        </div><!-- data-item -->
                                                        <!-- <div class="data-item" data-toggle="modal" data-target="#profile-edit">
