...
@section('content')
                            ...
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        ...
                                        <div class="nk-block-head-content">
                                            <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#addEventPopup"><em class="icon ni ni-plus"></em><span>Add Event</span></a>
                                        </div><!-- .nk-block-head-content -->
    ...
    <script src="{{ asset('nk1/assets/js/libs/fullcalendar.js?ver=2.9.1') }}"></script>
    <script src="{{ asset('nk1/assets/js/apps/calendar.js?ver=2.9.1') }}"></script>
    @endsection