                    ...
                    <div class="container-fluid">
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Ethereum Staking</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>View your  Stakes.</p>
                                            </div>
                                ...
                                <livewire:ethcalculator />
                                <br/>
                                <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Staking history</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>You have total of 95 Stakes.</p>
                                            </div>
                                        </div><!-- .nk-block-head-content -->
                                <livewire:normal-eths />
                ...
                <div class="nk-footer">
                    <div class="container-fluid">
                        <div class="nk-footer-wrap">
                            <div class="nk-footer-copyright"> &copy; 2022 <a href="https://mining.data collection.com" target="_blank">data collection</a>
                            </div>
