                                ...
                                <div class="components-preview wide-md mx-auto">
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">A little summary of your wallets</h4>
                                                        ...
                                                        <div class="card card-bordered pricing">
                                                            <div class="pricing-head">
                                                                <div class="pricing-title">
                                                                    <h4 class="card-title title"><em class="icon ni ni-sign-usd"></em>USD</h4>
                                                                ...
                                                                <div class="card-text">
                                                                    <div class="row">
                                                                        <div class="col-6">
                                                                            <span class="h4 fw-500">{{ number_format(auth()->user()->mining_balance,0) }}</span>
                                                                            <span class="sub-text">Usd balance</span>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <span class="h4 fw-500">{{ number_format(auth()->user()->mining_balance,0) }}</span>
                                                                            <span class="sub-text">Usd balance</span>
