                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        ...
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Crypto Porfolio</h2>
                                        </div>
                                               
                                                
                                            </div>
                                            <!--<h5 class="nk-block-title page-title">NFT purchase history</h5>-->
                                            <p>A look at all the crypto in your portfolio </p>
                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        <li><a href="/coining" class="btn btn-white btn-dim btn-outline-primary"><em class="icon ni ni-portfolio"></em><span>Invest and Earn</span></a></li>
                                                        <li><a href="/deposit-create" class="btn btn-white btn-dim btn-outline-primary"><em class="icon ni ni-wallet"></em><span>Deposit Funds</span></a></li>
                                                        ...
                                                        <div class="card card-bordered pricing">
                                                            <div class="pricing-head">
                                                                <div class="pricing-title">
                                                                    ...
                                                                    <p class="sub-text">This investment is in the crypto {{ $todo->todo_id ?? '' }}.</p>
                                                                             @if(isset($todo->filename))                 <img width="50" height="50" src="{{ asset('storage/'.$todo->filename) }}" />
                                                                             @endif
                                                                </div>
                                                                <div class="card-text">
                                                                    <div class="row">
                                                            ...
                                                            <div class="pricing-body">
                                                                ...
                                                                <li><span class="w-50">Deposit Amount</span> - <span class="ml-auto">{{ $todo->amount ?? 'no amount'}}</span></li>
                                                                    <!--<li><span class="w-50">Option type</span> - <span class="ml-auto">{{ $todo->payment }}</span></li>-->
                                       
                                                                    <li><span class="w-50">Start date</span> - <span class="ml-auto">{{ $todo->start_time ?? 'no start time' }}</span></li>
                                                                    <li><span class="w-50">End date</span> - <span class="ml-auto">{{ $todo->end_time ?? 'no end time' }}</span></li>
