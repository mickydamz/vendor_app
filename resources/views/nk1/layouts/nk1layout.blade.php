                        ...
                        <div class="nk-sidebar-content">
                            <div class="nk-sidebar-widget d-none d-xl-block">
                                <div class="user-account-info between-center">
                                    <div class="user-account-main">
                                        ...
                                        <div class="user-balance">1 <small class="currency currency-btc">USDT</small></div>
                                ...
                                <ul class="user-account-data gy-1">
                                    ...
                                    <li>
                                        ...
                                        <div class="user-account-value">
                                            <span class="sub-text"> <span class="currency currency-btc">USDT</span></span>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="nk-sidebar-widget nk-sidebar-widget-full d-xl-none pt-0">
                                ...
                                <div class="nk-profile-content toggle-expand-content" data-content="sidebarProfile">
                                    <div class="user-account-info between-center">
                                        <div class="user-account-main">
                                            <h6 class="overline-title-alt">Available Balance</h6>
                                            <div class="user-balance"> <small class="currency currency-btc">USDT</small></div>
                                    ...
                                    <ul class="user-account-data">
                                        ...
                                        <li>
                                            ...
                                            <div class="user-account-value">
                                                <span class="sub-text text-base"> <span class="currency currency-btc">BTC</span></span>
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            <div class="nk-sidebar-menu">
                                ...
                                <ul class="nk-menu">
                                    ...
                                    <li class="nk-menu-item">
                                        <a href="/profit-statement" class="nk-menu-link">
                                            <span class="nk-menu-icon"><em class="icon ni  ni-repeat"></em></span>
                                            <span class="nk-menu-text">Profit Statement</span>
                                        </a>
                                    </li>
