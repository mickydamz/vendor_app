                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Alerts Styles</h2>
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Examples - Default Style</h5>
                                                <p>Alerts are available for any length of text. Use <code>.alert-{state}</code> with <code>.alert</code> to create alert messages.</p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="example-alerts">
                                                    <div class="gy-4">
                                                        ...
                                                        <div class="example-alert">
                                                            <div class="alert alert-fill alert-gray alert-icon">
                                                                <em class="icon ni ni-alert-circle"></em> Your credit card <strong>already expired</strong>. Please enter a valid & up-to-date <a href="#" class="alert-link">credit card</a> for make deposit.
                                                            </div>
                                                        </div>
                                                        <div class="example-alert">
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><code>.alert-{state}</code></td>
                                                        <td>Use <code>{state}</code> as <code>primary, secondary, success, info, warning, danger, gray, light</code></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.alert-icon</code></td>
                                                        <td><span>Use with <code>.alert</code> class for proper icon style.</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.alert-fill</code></td>
                                                        <td><span>Use with <code>.alert</code> class for fill base style.</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.alert-dismissible</code></td>
                                                        <td><span>Use with <code>.alert</code> class for dismissible alert.</span></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div><!-- .card-preview -->
                                        <div class="code-block">
                                            ...
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#alertCode1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="alertCode1">
...
&lt;/div&gt;
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#alertCode2" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="alertCode2">
...
&lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Examples - Style Pro</h5>
                                                <p>For following style, You can use the <code>.alert-pro</code> class with <code>.alert</code> class.</p>
                                            </div>
                                        </div>
                                        <div class="example-alerts">
                                            <div class="gy-4">
                                                ...
                                                <div class="example-alert">
                                                    <div class="alert alert-pro alert-warning">
                                                        <div class="alert-text">
                                                            ...
                                                            <p>Sorry! your credit card already expired. Please enter a valid & up-to-date credit card for make deposit.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="example-alert">
                                                ...
                                                <div class="example-alert">
                                                    <div class="alert alert-pro alert-light">
                                                        <div class="alert-text">
                                                            <h6>Your Order Placed</h6>
                                                            <p>Your order has been successfully placed for diposit. Your will be redirect for make your payment. </p>
                                                        </div>
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#alertCode3" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="alertCode3">
&lt;div class=&quot;alert alert-pro alert-primary&quot;&gt;
    &lt;div class=&quot;alert-text&quot;&gt;
        &lt;h6&gt;Your Order Placed&lt;/h6&gt;
        &lt;p&gt;Your order has been successfully placed for diposit. Your will  be redirect for make your payment. &lt;/p&gt;
