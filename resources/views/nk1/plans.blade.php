                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Available Plans</h2>
                                        </div>
                                    </div>
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Below are plans you can profit from</h4>
                                                        ...
                                                        <div class="card card-bordered pricing">
                                                            ...
                                                            <div class="pricing-body">
                                                                <ul class="pricing-features">
                                                                    <!--<li><span class="w-50">Price</span> - <span class="ml-auto">{{ $todo->price }}</span></li>-->
                                                                ...
                                                                <div class="pricing-action">
                                                                    <button class="btn btn-outline-light"><a href="/planing">Choose this plan</a></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
