                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Available Coins</h2>
                                        </div>
                                    </div>
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Below are coins you can profit from</h4>
                                                        ...
                                                        <div class="card card-bordered pricing">
                                                            <div class="pricing-head">
                                                                <div class="pricing-title">
                                                                    ...
                                                                    <img width="250" height="250" src="{{ asset('storage/'.$todo->fileName) }}" />
                                                                </div>
                                                                <div class="card-text">
                                                                    <div class="row">
                                                                        <!-- <div class="col-6">
                                                            ...
                                                            <div class="pricing-body">
                                                                <ul class="pricing-features">
                                                                    <!--<li><span class="w-50">Deposit Amount</span> - <span class="ml-auto">{{ $todo->price }}</span></li>-->
                                                                ...
                                                                <div class="pricing-action">
                                                                    <button class="btn btn-outline-light"><a href="/coining">Choose this plan</a></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
