                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        ...
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">NFT Porfolio</h2>
                                        </div>
                                               
                                                
                                            </div>
                                            <!--<h5 class="nk-block-title page-title">NFT purchase history</h5>-->
                                            <p>A look at all the nfts in your portfolio </p>
                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        <li><a href="/nfting" class="btn btn-white btn-dim btn-outline-primary"><em class="icon ni ni-portfolio"></em><span>Invest and Earn</span></a></li>
                                                        ...
                                                        <div class="card card-bordered pricing">
                                                            <div class="pricing-head">
                                                                <div class="pricing-title">
                                                                    ...
                                                                    <p class="sub-text">This investment is in the nft {{ $todo->todo_id ?? '' }}.</p>
