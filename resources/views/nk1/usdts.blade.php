                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">View Usdt stakes</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>View usdt stakes.</p>
                                            </div>
                ...
                <div class="nk-footer">
                    <div class="container-fluid">
                        <div class="nk-footer-wrap">
                            <div class="nk-footer-copyright"> &copy; 2022 data collection <a href="https://data collection" target="_blank"></a>
                            </div>
