                                            ...
                                            <div class="card card-bordered card-full">
                                                <div class="card-inner">
                                                    <div class="card-title-group mb-1">
                                                        <div class="card-title">
                                                            <h6 class="title">General Overview</h6>
                                                            <p>The general overview of your activity. <a href="#">All activity</a></p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="tab-content mt-0">
                                                        <div class="tab-pane active" id="overview">
                                                            <div class="invest-ov gy-2">
                                                                <div class="subtitle">Current Activities</div>
                                                            ...
                                                            <div class="invest-ov gy-2">
                                                                <div class="subtitle">Activity in this Month</div>
                                                                <div class="invest-ov-details">
                                                                    <div class="invest-ov-info">
                                                                        <div class="amount">49,395.395 <span class="currency currency-usd">USD</span></div>
                                                                        <div class="title">Amount</div>
                                                        ...
                                                        <div class="tab-pane" id="thisyear">
                                                            <div class="invest-ov gy-2">
                                                                <div class="subtitle">Current Activity</div>
                                                                <div class="invest-ov-details">
                                                                    <div class="invest-ov-info">
                                                            ...
                                                            <div class="invest-ov gy-2">
                                                                <div class="subtitle">Activity this Month</div>
                                                                <div class="invest-ov-details">
                                                                    <div class="invest-ov-info">
                                                        ...
                                                        <div class="tab-pane" id="alltime">
                                                            <div class="invest-ov gy-2">
                                                                <div class="subtitle">Currentl Activity</div>
                                                                <div class="invest-ov-details">
                                                                    <div class="invest-ov-info">
